...
from app.middlewares import AuthenticationMiddleware
from app.backends import BasicAuthBackend
...
app = Starlette(debug=False, routes=routes, middleware=middleware)ling authentication
