...
class HTTPException(Exception):
    def __init__(
        ...
        headers: typing.Union[typing.Dict[str, str], None] = None,
    ) -> None:
        if detail is None:
...
class WebSocketException(Exception):
    def __init__(self, code: int, reason: typing.Union[str, None] = None) -> None:
        self.code = code
...
def __dir__() -> list[str]:
    return sorted(typing.cast(typing.List[str], list(__all__)) + [__deprecated__])  # pragma: no cover
