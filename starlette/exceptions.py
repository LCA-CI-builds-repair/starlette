...
class HTTPException(Exception):
    def __init__(
        self,
        status_code: int,
        detail: str | None = None,  # Use 'typing.Union' for Python < 3.10 compatibility
...
class WebSocketException(Exception):
    def __init__(self, code: int, reason: typing.Union[str, None] = None) -> None:  # Use 'typing.Union' for Python < 3.10 compatibility
        self.code = code
...
def __dir__() -> typing.List[str]:  # Use 'typing.List' instead of 'list'
