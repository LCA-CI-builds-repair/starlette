...
class Starlette:
    ...
    * **debug** - Boolean indicating if debug tracebacks should be returned on errors.
    ...
    - **middleware**: A list of middleware to run for every request. The `Starlette` application will automatically include two middleware classes. `ServerErrorMiddleware` is added as the outermost middleware to handle any uncaught errors occurring in the stack.
